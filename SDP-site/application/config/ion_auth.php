 ...
 */
$config['site_title']           = "UTS Housing"; 		// Site Title, example.com
...
$config['user_expire']          = 2419200; //28 days	// How long to remember the user (seconds). Set to zero for no expiration (default: 86500)
$config['user_extend_on_login'] = TRUE; 				// Extend the users cookies everytime they auto-login (default: FALSE)
