<div class="request">
	...
	<ul>
		...
		<li>  Click on <img src="<?php echo base_url("images/desktop_submit_request.PNG") ?>" alt="add" height="27" width="102"> when you have finished filling in the form </li>
	</ul>
	...
	<h1>Editing Request</h1>
		...
		<ul>
			<li> Select the requst which is going to edit on the list. </li>
			<li> Click on <img src="<?php echo base_url("images/desktop_edit_request.PNG") ?>" alt="add" height="27" width="72"> and start the editing.</li>
			<li> Do not forget to click on <img src="<?php echo base_url("images/desktop_update_request.PNG") ?>" alt="add" height="27" width="102"> to save the changes.</li>
		</ul>
	<h1>User Settings</h1>
	...
	<?php if($this->ion_auth->is_admin()): ?>
		...
		<p><b>** Note that this function is only available to administrator**</b></p></br>
		...
		<ul>
			<li>Add User : Click on <img src="<?php echo base_url("images/desktopAdd.PNG") ?>" alt="add" height="27" width="72"> button on top right corner, fill out the form and entered data will be insert to database</li>
			<li>Veiw User : Simply click on one of users in the users list, the details will shown on a form.</li>
			<li>Edit User : At the user view, click on the <img src="<?php echo base_url("images/desktopEdit.PNG") ?>" alt="edit" height="27" width="72">  located on top right corner, edit anything which needed to update.</li>
			<li>Delete User : At the edit user, there is a button called<img src="<?php echo base_url("images/desktopDelete.PNG") ?>" alt="delete" height="27" width="82">, once the button is clicked, the user which being viewed will be deleted and it can not be <b>UNDO</b>.</li>
		</ul>
	<?php endif;?>
</div>
